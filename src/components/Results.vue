  ...
  <div class="mx-auto p-4 lg:p-12 mt-32 lg:mt-28 max-w-[1920px]">
    <div v-if="projectData">
      ...
      <div v-else class="grid gap-8 grid-cols-12 items-start">
        ...
        <Block
          id="css"
          class="col-span-12 lg:col-span-6 xl:col-span-4 scroll-mt-24 self-stretch"
          variant="css">
          <div class="bg-white rounded-lg p-4 flex gap-4 items-center mb-8">
        ...
        <BlockCssVariables :projectData="projectData" />
        ...
        <!-- <BlockCssQuality :projectData="projectData" /> -->
...
import BlockCssUnit from "./Blocks/BlockCssUnit.vue"; // Sauvegardé dans BlockCssUnit_OLD.vue
import BlockCssSelectors from "./Blocks/BlockCssSelectors.vue"; // Sauvegardé dans BlockCssSelectors_OLD.vue
import BlockCssRules from "./Blocks/BlockCssRules.vue"; // Sauvegardé dans BlockCssRules_OLD.vue
import BlockCssProperties from "./Blocks/BlockCssProperties.vue"; // Sauvegardé dans BlockCssProperties_OLD.vue
