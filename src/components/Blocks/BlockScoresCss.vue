<template>
  <Block
    ...
    <div class="grid grid-cols-2 gap-8 md:grid-cols-5">
      ...
      <div class="flex flex-col gap-8 items-center">
        <h4 class="text-sm">Couleurs</h4>
        <ProgressCircle
          :value="props.projectData.cssAnalysisResult.colors.score.total / 100"
          :averageValue="props.classStats?.stats?.cssColors?.mean / 100" />
      </div>
      <div class="flex flex-col gap-8 items-center">
      ...
      <p
        class="col-span-2 md:col-span-4 text-xs text-slate-500 flex items-center gap-2">
